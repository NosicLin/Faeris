-- 一个场景一个scene
dofile=f_import
dofile("script/ButtonComFunction.lua")
dofile("script/PlayFunction.lua")
dofile("script/SceneAbout.lua")
dofile("script/SceneAchieve.lua")
dofile("script/ScenePlay.lua")
dofile("script/SceneSupport.lua")
dofile("script/SceneStart.lua")
dofile("script/SceneLogo.lua")

local director = share:director()
 local scene = SceneLogo_New() -- 正式版从Logo开始
-- local scene = ScenePlay_New()
director:run(scene)
