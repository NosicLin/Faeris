...
local function Press_OnTouchEnd(selfLayer, x, y)
	...
	if selfLayer.data.pressedButton ~= nil then
		...
		if pressedButton:hit2D(x, y) then
			-- 不同的按钮不同的事件
			if pressedButton == selfLayer.data.offButList[0] then
				print("Thank you!")
			elseif pressedButton == selfLayer.data.offButList[1] then
...
local function LayerUI_Create()
	...
	AddButton(layerUI, 236, 331, 0, "textures/game/supportComfirmOff.png", "textures/game/supportConfirmOn.png", Rect2D(-64, -24, 128, 48))
	AddButton(layerUI, 410, 115, 1, "textures/game/backOff.png", "textures/game/backOn.png", Rect2D(-64, -24, 128, 48))
