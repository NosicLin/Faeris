...
local aboutText = 
{
	...
	{
		text = "3Faeris Tetris v1.0",
		x = 240,
		y = 510,
		color = Color(20, 100, 50),
		size = 30,
	},
	{
		text = "4Thank you for playing!",
		x = 240,
		y = 448,
		color = Color(50, 50, 240),
		size = 40,
	},
}
...
local function LayerBK_Create()
	...
	local i = 1
	for i = 1 ,#aboutText do 
		local text = aboutText[i]
