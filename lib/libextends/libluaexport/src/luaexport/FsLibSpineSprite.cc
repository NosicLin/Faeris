...
** Generated automatically by tolua++-1.0.92 on 07/31/13 12:59:27.
*/
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"SpineSprite");
}

/* method: create of class  SpineSprite */
...
#endif
 {
  const char* filename = ((const char*)  tolua_tostring(tolua_S,2,0));
  {
   SpineSprite* tolua_ret = (SpineSprite*)  SpineSprite::create(filename);
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"SpineSprite");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
TOLUA_API int tolua_FsSpineSprite_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  tolua_cclass(tolua_S,"SpineSprite","SpineSprite","Entity",NULL);
